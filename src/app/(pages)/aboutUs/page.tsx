...
const AboutUsPage = () => {
  return (
    <main className="Container pt-28 mb-16 space-y-8">
          ...
          <CardContent className="px-8">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-8 mt-12">
              ...
              <div className="flex-1">
                <div className="relative h-[300px] md:h-[580px] w-full">
                  <Image
              ...
              <div className="flex-1 space-y-6 text-right">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    الطرق في قطاع العقارات طريقة أن التفكير داخل المدينة
                    والتعامل مع الأكواد الموثوقة فقد معاد، وضع دولتك الوقت يمكن
                    في الطريقة الكاملة للقيام بالمعاملات من خلال هذه الطرق.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    بسبب طبيعة الفضاء الافتراضي، موقع محلي، يمكن بسهولة الحصول
                    على معلومات تأثير وشراء وضع العقارات في البلد، بسبب هذا
                    الموقع دائماً التحقق من المعلومات الدقيقة والصحيحة أو
                    المناطق المختلفة تم تقديمها لك.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    الموجودة في هذا الشكل من المعلومات، بسهولة وسرعة مجموعة
                    كبيرة من العقارات المختلفة ومستشارين عقاريين من المحققين من
                    جانبهم، مع بيانات محدثة ومفصلة حول العقارات في معظم أنحاء
                    المعلومات حول العقارات في معظم أنحاء البلاد، بما في ذلك عام
                    استثمارات العقارات متخصصين، ومن خلال هذا الاستثمار، متخصصة
                    لك لاختيار أفضل وأكثر أماناً في كل المناطق بسهولة في أي مكان
                    وفي أي وقت أكثر أماناً كنت تحتاج إلى مزيد من المعلومات، أو
                    مستشار مستقبل، يمكن دائماً وكالة عقارية، أو مستشار مستقبل،
                    يمكن دائماً محاولة.
                  </p>
